...
class huya_danmu extends events {
	...
	_start_ws() {
		// wsapi.huya.com
		// ws.api.huya.com
		this._client = new ws('ws://wsapi.huya.com', {
	...
	_on_mes(data) {
		try {
			...
			// if(command.iCmdType != 4 && command.iCmdType != 7){
			//     // console.log(command.iCmdType)
			//     // console.log(map.vVipBarItem.proto.tNobleInfo)
			// }
			switch (command.iCmdType) {
				...
				case HUYA.EWebSocketCommandType.EWSCmdS2C_MsgPushReq:
					// console.log(HUYA.EWebSocketCommandType.EWSCmdS2C_MsgPushReq)
